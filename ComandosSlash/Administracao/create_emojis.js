...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        await interaction.reply({ content: "🔄 Colocando os emojis, aguarde...", flags: [Discord.MessageFlags.Ephemeral] });
        ...
        try {
            ...
            await interaction.editReply({ content: "✅ Emojis adicionados com sucesso neste servidor! Lembre-se de reiniciar o bot para garantir que as alterações entrem em vigor.", flags: [Discord.MessageFlags.Ephemeral] });
        } catch (error) {
            console.error("Erro ao criar emojis:", error);
            interaction.reply({ content: "âŒ Ocorreu um erro ao adicionar os emojis.", flags: [Discord.MessageFlags.Ephemeral] });
        }
    },
};
