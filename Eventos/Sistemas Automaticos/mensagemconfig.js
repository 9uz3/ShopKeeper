        ...
        try {
            if (interaction.isButton()) {
                if (interaction.customId === 'configmsgauto') {
                    ...
                    if (isNaN(idToDelete)) {
                        return interaction.reply({ content: 'ID inválido.', flags: [Discord.MessageFlags.Ephemeral] });
                    }
                    ...
                    await interaction.reply({ content: 'Mensagem deletada com sucesso.', flags: [Discord.MessageFlags.Ephemeral] });
            ...
            if (interaction.isModalSubmit()) {
                if (interaction.customId === 'configModal') {
                    ...
                    if (isNaN(deleteTime) || isNaN(repostTime)) {
                        return interaction.reply({ content: 'Os tempos devem ser números válidos.', flags: [Discord.MessageFlags.Ephemeral] });
                    }
