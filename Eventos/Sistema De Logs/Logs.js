    ...
    run: async (message, client) => {
        ...
        const embed = new EmbedBuilder()
            ...
            .setAuthor({
                ...
                iconURL: 'https://media.discordapp.net/attachments/1223385767816986754/1250235239499038740/eu_tambem_tenho_25.png?ex=666a33cd&is=6668e24d&hm=665c5dc1a780f607f0c590b233cd794e650fb7803a6477d14c59f5b3b0fe7c6b&=&format=webp&quality=lossless'
            })
            ...
            .addFields(
                ...
                { name: '**Mensagem**', value: message.content || 'Mensagem sem conteúdo' }
            )
