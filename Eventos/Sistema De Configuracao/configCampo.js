        ...
        if (interaction.type == Discord.InteractionType.ModalSubmit) {
            if (interaction.customId === 'sdaju11111idsjjs123dua123') {
                ...
                if (a1 !== '') {
                    if (regexPadrao.test(a1)) {
                        ...
                        return interaction.reply({ flags: [Discord.MessageFlags.Ephemeral], content: `âŒ Cor \`${a1}\` inválida (Principal).` })
                    }
                }
                if (a2 !== '') {
                    if (regexPadrao.test(a2)) {
                        ...
                        return interaction.reply({ flags: [Discord.MessageFlags.Ephemeral], content: `âŒ Cor \`${a2}\` inválida (Processamento).` })
                    }
                }
                if (a3 !== '') {
                    if (regexPadrao.test(a3)) {
                        ...
                        return interaction.reply({ flags: [Discord.MessageFlags.Ephemeral], content: `âŒ Cor \`${a3}\` inválida (Sucesso).` })
                    }
                }
                if (a4 !== '') {
                    if (regexPadrao.test(a4)) {
                        ...
                        return interaction.reply({ flags: [Discord.MessageFlags.Ephemeral], content: `âŒ Cor \`${a4}\` inválida (Falha).` })
                    }
                }
                if (a5 !== '') {
                    if (regexPadrao.test(a5)) {
                        ...
                        return interaction.reply({ flags: [Discord.MessageFlags.Ephemeral], content: `âŒ Cor \`${a5}\` inválida (Finalizado).` })
                    }
                }

                interaction.reply({ content: `✅ | Cores atualizadas com sucesso!`, flags: [Discord.MessageFlags.Ephemeral] })
            ...
            if (interaction.customId === 'sdaju11111231idsjjs123dua123') {
                ...
                if (a1 !== '') {
                    try {
                        ...
                        return interaction.reply({ flags: [Discord.MessageFlags.Ephemeral], content: `âŒ Nome inserido \`${a1}\` inválido ou então você alterou mais de 3 vezes o nome em 1 hora!` })
                    }
                }
                if (a2 !== '') {
                    try {
                        ...
                        return interaction.reply({ flags: [Discord.MessageFlags.Ephemeral], content: `âŒ Avatar inserido \`${a2}\` inválido.` })
                    }
                }
                ...
                await interaction.reply({ content: `✅ | Configurações atualizadas com sucesso!`, flags: [Discord.MessageFlags.Ephemeral] })
            ...
            if (interaction.customId === 'dassdadassddsdasddassddasd') {
                ...
                if (ADD !== '') {
                    ...
                    if (ddd == null) return interaction.reply({ flags: [Discord.MessageFlags.Ephemeral], content: `âŒ Cargo inserido \`${ADD}\` inválido.` })
                ...
                if (REM !== '') {
                    ...
                    if (ddd == null) return interaction.reply({ flags: [Discord.MessageFlags.Ephemeral], content: `âŒ Cargo inserido \`${REM}\` inválido.` })
                ...
                interaction.followUp({ content: `✅ | Alterações realizadas com sucesso!`, flags: [Discord.MessageFlags.Ephemeral] })
            ...
            if (interaction.customId === 'configcampoo') {
                ...
                if (isNaN(preco)) return interaction.reply({ flags: [Discord.MessageFlags.Ephemeral], content: `âŒ Preço inserido \`${preco}\` inválido.` })

                if (ggg.camposelect !== nomecampo) {
                    const campos = produtos.get(`${ggg.name}.Campos`) || [];
                    if (campos.some((campo) => campo.Nome === nomecampo)) {
                        return interaction.reply({ flags: [Discord.MessageFlags.Ephemeral], content: `❌ Nome do campo já existente neste produto.` });
                    }
                }
            ...
            if (interaction.customId == 'definircondicoes') {
                ...
                if (idcargo !== '') {
                    ...
                    if (ddd == null) return interaction.reply({ flags: [Discord.MessageFlags.Ephemeral], content: `âŒ Cargo inserido \`${idcargo}\` inválido.` })
                }

                if (valorminimo !== '') {
                    valorminimo = parseInt(valorminimo, 10);
                    if (!Number.isInteger(valorminimo)) {
                        return interaction.reply({ flags: [Discord.MessageFlags.Ephemeral], content: `âŒ Quantidade inserida \`${valorminimo}\` inválido. Insira apenas números inteiros.` });
                    }
                }
                ...
                if (valormaximo !== '') {
                    ...
                    if (!Number.isInteger(valormaximo)) {
                        return interaction.reply({ flags: [Discord.MessageFlags.Ephemeral], content: `âŒ Quantidade inserida \`${valormaximo}\` inválido. Insira apenas números inteiros.` });
                    }
                }
...
**Deseja adicionar o valor de \`${qtdlinhas}\`\ itens ao estoque de \`${ggg22.campo}\`?**
            ...
            if (interaction.customId == 'sd1213aju11111idsjjsdua') {
                ...
                if (qtd > 100000) return interaction.reply({ content: `âŒ Não foi possível adicionar esse estoque.`, flags: [Discord.MessageFlags.Ephemeral] })

                if (isNaN(qtd)) return interaction.reply({ content: `âŒ Esse número não é válido \`${qtd}\`.`, flags: [Discord.MessageFlags.Ephemeral] })
                ...
                await interaction.reply({ content: `🔄 Aguarde...`, flags: [Discord.MessageFlags.Ephemeral] }).then(async tt => {
                    ...
                    await tt.edit({ content: `🔄 Sincronizando mensagens...`, flags: [Discord.MessageFlags.Ephemeral] }).then(async msg => {
                        await UpdateMessageProduto(client, ggg.name)

                    })

                    await tt.edit({ content: `✅ Total de \`${qtd}\` itens fantasma adicionado ao estoque.`, flags: [Discord.MessageFlags.Ephemeral] })
                })
            ...
            if (interaction.customId == 'sdaju11124124111231idsjjs123dua123') {
                ...
                if (qtd !== 'sim') return interaction.reply({ content: `âŒ Confirmação não validada.`, flags: [Discord.MessageFlags.Ephemeral] });
                ...
                try {
                    const syncMessage = await interaction.followUp({ content: `🔄 Sincronizando mensagens...`, flags: [Discord.MessageFlags.Ephemeral], fetchReply: true });
                    await UpdateMessageProduto(client, ggg.name);
        ...
        if (interaction.isButton()) {
            ...
            if (interaction.customId == 'estoquearquivo') {
                ...
                interaction.reply({ 
                    flags: [Discord.MessageFlags.Ephemeral], 
                    content: `â“ Envie um ou mais arquivo de texto contendo o estoque que deseja adicionar, expira <t:${Math.ceil(timeStamp / 1000)}:R>.`
                }).then(msgggg => {
                        ...
                        if (message.attachments.size > 0) {
                            ...
                            try {
                                ...
                                if (error.response && error.response.status === 404) {
                                    await interaction.editReply({ content: 'âŒ Ocorreu um erro ao processar o arquivo: URL do anexo não encontrada. Tente novamente.' });
                                } else {
                                    await interaction.editReply({ content: 'âŒ Ocorreu um erro ao processar o arquivo. Tente novamente.' });
                                }
                            }
                        }
                    });
                    ...
                    collector.on('end', collected => {
                        if (collected.size === 0) {
                            msgggg.edit({ content: `âš ï¸ Tempo esgotado.` });
                        }
                    });
                });
            }
            ...
            if (interaction.customId == 'simestoque') {
                ...
                await interaction.editReply({ content: `🔄 Sincronizando mensagens...`, flags: [Discord.MessageFlags.Ephemeral] })
            ...
            if (interaction.customId.startsWith('avisarestoqueeeee')) {
                ...
                if (yy == 0 || yy == undefined) return interaction.update({ content: `âŒ Nenhum usuário para avisar.`, flags: [Discord.MessageFlags.Ephemeral], components: [] })
                ...
                interaction.update({ content: `✅ Avisamos os ${yy.length} que seu produto foi reabastecido com sucesso!`, flags: [Discord.MessageFlags.Ephemeral], components: [] })
            ...
            if (interaction.customId == 'estoquedsadas') {
                ...
                if (gggaaa.estoque == 0) {
                    interaction.reply({ content: `âš ï¸ O estoque desse item está vazio.`, flags: [Discord.MessageFlags.Ephemeral] })
                } else {
                    ...
                    await interaction.reply({ content: `🔄 Aguarde...`, flags: [Discord.MessageFlags.Ephemeral] }).then(async tt => {
                        ...
                        await tt.edit({
                            flags: [Discord.MessageFlags.Ephemeral], files: [{
            ...
            if (interaction.customId == 'excluirproduto') {
                ...
                interaction.followUp({ content: `✅ | Produto excluído com sucesso!`, flags: [Discord.MessageFlags.Ephemeral] })
            }
            ...
            if (interaction.customId == 'gwdawdwadawawderenciarcampossss') {
                ...
                const newnameboteN2 = new TextInputBuilder()
                    .setCustomId('tokenMP2')
                    .setLabel(`VALOR MíNIMO DE COMPRA`)
                ...
                const newnameboteN4 = new TextInputBuilder()
                    ...
                    .setLabel(`VALOR MíXIMO DE COMPRA`)
            ...
            if (interaction.customId == 'editarcampooo') {
                ...
                const newnameboteN4 = new TextInputBuilder()
                    .setCustomId('tokenMP3')
                    .setLabel(`DESCRIÇíO DO CAMPO (OPCIONAL)`)
