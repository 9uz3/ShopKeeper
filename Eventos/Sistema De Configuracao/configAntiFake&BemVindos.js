        ...
        if (interaction.isButton()) {
            if (interaction.customId === 'personalizarantifake') {
                ...
                const newnameboteN = new TextInputBuilder()
                    .setCustomId('tokenMP')
                    .setLabel(`QUANTIDADE DE DIAS MíNIMA PARA ENTRAR`)
            ...
            if (interaction.customId === 'joaozinhoAntiFake') {
                ...
                if (title !== 'não') {
                    if (!isNaN(title)) {
                        ...
                        interaction.reply({ content: `âŒ | Você colocou um numero incorreto nos dias!`, flags: [Discord.MessageFlags.Ephemeral] })
                        return
                    }
                } else {
                ...
                interaction.reply({ content: `✅ | Todas configurações de Anti-Fake foram configuradas com sucesso!`, flags: [Discord.MessageFlags.Ephemeral] })
