    ...
    run: async (interaction, client) => {
        ...
        if (interaction.type == Discord.InteractionType.ModalSubmit) {
            if (interaction.customId === 'awdwadpiawjdboawidbae8h6fafah8f') {
                ...
                if (Number.isInteger(qtd)) return interaction.reply({ content: `âŒ O número de desconto inserio é inválido \`${qtd}\``, flags: [Discord.MessageFlags.Ephemeral] })
                if (dias !== '') {
                    if (Number.isInteger(dias)) return interaction.reply({ content: `âŒ O número de dias inserio é inválido \`${dias}\``, flags: [Discord.MessageFlags.Ephemeral] })
                ...
                if (produtoExistente) return interaction.reply({ flags: [Discord.MessageFlags.Ephemeral], content: `âŒ Nome do cupom já existente.` })
                ...
                interaction.followUp({ components: [row3], content: `✅ Cupom criado.`, flags: [Discord.MessageFlags.Ephemeral] }).then(async msgg => {
            ...
            if (interaction.customId === 'doinabuydoboudwoaynidnioawdawdiaw') {
                ...
                if (cargospodeusar !== '') {
                    ...
                    if (ddd == null) return interaction.reply({ flags: [Discord.MessageFlags.Ephemeral], content: `âŒ Cargo inserido \`${cargospodeusar}\` inválido.` })
        ...
        if (interaction.isButton()) {
            ...
            if (interaction.customId == 'remcupom') {
                ...
                if (ggg == 0) {
                    interaction.reply({ flags: [Discord.MessageFlags.Ephemeral], content: `âŒ Esse produto ainda não possuí nenhum cupom.` })
                    return
                }
                ...
                try {
                    ...
                    await interaction.update({ components: [style2row], content: `â“ Quais cupons de \`${ggg22.Config.name}\` deseja remover?`, embeds: [] })
                } catch (error) {
                }
            }
            ...
            if (interaction.customId == 'configavccupomm') {
                ...
                const newnameboteN = new TextInputBuilder()
                    .setCustomId('tokenMP')
                    .setLabel(`MíXIMO DE USOS (POR PESSOA)`)
                ...
                const newnameboteN4 = new TextInputBuilder()
                    ...
                    .setLabel(`QUANTIDADE MíNIMA (SE QUISER UM LIMITE)  `)
                ...
                const newnameboteN5 = new TextInputBuilder()
                    ...
                    .setLabel(`QUANTIDADE MíXIMA (SE QUISER UM LIMITE)`)
