            ...
            if (Date.now() > tenMinutesLater) {
                ...
                try {
                    ...
                    const mandanopvdocara = new EmbedBuilder()
                        .setColor(`${configuracao.get(`Cores.Erro`) == null ? `#EF4444` : configuracao.get(`Cores.Erro`)}`) //ff0000
                    ...
                    console.error(`Erro ao enviar log de expiração:`, error);
                }
                continue
            }
            ...
            if (res?.data?.status == 'approved' || payment.data.pagamentos.id == `Aprovado Manualmente`) { //pending // approved
                ...
                if (configuracao.get('pagamentos.BancosBloqueados') !== null) {
                    ...
                    const embed = new EmbedBuilder()
                        .setColor(`${configuracao.get(`Cores.Erro`) == null ? `#EF4444` : configuracao.get(`Cores.Erro`)}`)
                    ...
                    if (dd?.status == 400) {
                        ...
                        try {
                            ...
                            console.error(`Erro ao enviar log de bloqueio:`, error);
                        }
                    ...
                    console.error(`Erro ao adicionar cargo de cliente:`, error);
                }
                ...
                const dsfjmsdfjnsdfj2 = new EmbedBuilder()
                    .setColor(`${configuracao.get(`Cores.Sucesso`) == null ? `#22C55E` : configuracao.get(`Cores.Sucesso`)}`) //40fc04
