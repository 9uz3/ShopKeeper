    ...
    for (const entrega of yy22) {
        ...
        if (autoentrega == true) {
            ...
            const dsfjmsdfjnsdfj2 = new EmbedBuilder()
                ...
                .setAuthor({ name: `Pedido #${entrega.data.id}`, iconURL: `https://cdn.discordapp.com/attachments/1249858017567051867/1264128373844873368/compra-aprovada.jpg?ex=669cbeca&is=669b6d4a&hm=46aa5fe08915c0251e3ca49d547aa9cf9dc7dccb3013c49b5e9e5e43b2add650&` })
            ...
            try {
                ...
                .addFields(
                    { name: `**Carrinho**`, value: `\`${yy.quantidadeselecionada}x ${yy.infos.produto} - ${yy.infos.campo}\``, inline: true },
